...
<!-- Featured Section -->
<section class="py-24 bg-white dark:bg-slate-900 relative transition-colors duration-500" id="featured">
    <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div data-aos="fade-left">
                <span class="text-primary font-bold tracking-widest uppercase text-sm mb-2 block"
                    data-i18n="featured_selection">Premium Selection</span>
                <h2 class="text-4xl md:text-5xl font-black text-dark dark:text-white mb-4 tracking-tight"
                    data-i18n="featured_title">
                    إصدارات <span
            ...
            <a href="products.php"
                ...
                data-aos="fade-right">
                <span data-i18n="featured_explore">استكشف كافة المنتجات</span>
